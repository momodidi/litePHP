...
return  array(
    ...
    /* 默认设定 */
    'DEFAULT_M_LAYER'       =>  'Model', // 默认的模型层目录名称
    'DEFAULT_C_LAYER'       =>  'Controller', // 默认的控制器层目录名称
    ...
    'DATA_CRYPT_TYPE'       =>  '',    // 数据加密方式
    'LOAD_EXT_FILE' => 'functions',   //需要加载的应用根目录Common下的文件名，以逗号隔开，纯名字，不带后缀php
    'LOAD_EXT_CONFIG'=>'',    //同上，需要加载的公共配置文件
